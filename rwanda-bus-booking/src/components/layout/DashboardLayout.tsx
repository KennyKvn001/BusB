  ...
  const getNavLinks = () => {
    if (hasRole([UserRole.ADMIN])) {
      return [
        ...
        { to: '/admin/operators', label: 'Operators', icon: 'briefcase' },
    ...
    if (hasRole([UserRole.OPERATOR])) {
      return [
        ...
        { to: '/operator/buses', label: 'My Buses', icon: 'truck' },
        { to: '/operator/routes', label: 'My Routes', icon: 'map' },
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="md:hidden">
        <div className={`${isSidebarOpen ? 'block' : 'hidden'} fixed inset-0 z-40 flex`}>
            ...
            <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
              ...
              <nav className="mt-5 px-2 space-y-1">
                {navLinks.map((item) => (
                  ...
                  >
                    <span className={`${
                      location.pathname === item.to ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500'
                    } mr-3`}>
                      {getIcon(item.icon)}
                    </span>
                    {item.label}
